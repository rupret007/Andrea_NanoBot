...
async function runLiveMode(): Promise<void> {
  ...
  printBlock('BLUEBUBBLES LIVE PROOF', [
    ...
    `shadow_poll_last_ok: ${truth.bluebubbles.shadowPollLastOkAt}`,
    `shadow_poll_last_error: ${truth.bluebubbles.shadowPollLastError}`,
    `shadow_poll_most_recent_chat: ${truth.bluebubbles.shadowPollMostRecentChat}`,
    `most_recent_server_seen_at: ${truth.bluebubbles.mostRecentServerSeenAt}`,
    `most_recent_server_seen_chat: ${truth.bluebubbles.mostRecentServerSeenChatJid}`,
    `most_recent_webhook_observed_at: ${truth.bluebubbles.mostRecentWebhookObservedAt}`,
    `most_recent_webhook_observed_chat: ${truth.bluebubbles.mostRecentWebhookObservedChatJid}`,
    ...
    `last_ignored_at: ${truth.bluebubbles.lastIgnoredAt}`,
    ...
    `cross_surface_fallback_state: ${truth.bluebubbles.crossSurfaceFallbackState}`,
    `cross_surface_fallback_last_sent_at: ${truth.bluebubbles.crossSurfaceFallbackLastSentAt}`,
