...
export const PUBLIC_TELEGRAM_COMMAND_SURFACES: readonly CommandSurfaceEntry[] =
  [
    ...
    {
      id: 'telegram_mainchat',
      preferredAlias: '/mainchat',
      acceptedAliases: ['/mainchat'],
      audience: 'user',
      surfaceKind: 'slash',
      channelScope: ['telegram'],
      discoverability: ['/start', '/help', '/commands'],
      truthClass: 'live_proven',
      summary: 'Show current main-control chat and exact recovery steps.',
      menuDescription: 'Show the current main control chat',
    },
    {
      id: 'telegram_bluebubbles',
      preferredAlias: '/bluebubbles',
      acceptedAliases: ['/bluebubbles'],
      audience: 'user',
      surfaceKind: 'slash',
      channelScope: ['telegram'],
      discoverability: ['/commands', '/help'],
      truthClass: 'live_proven',
      summary:
        'Show current BlueBubbles transport, proof, blocker, and next action.',
      menuDescription: 'BlueBubbles status',
    },
    {
      id: 'telegram_thinking',
      preferredAlias: '/thinking',
      acceptedAliases: ['/thinking'],
      audience: 'user',
      surfaceKind: 'slash',
      channelScope: ['telegram'],
      discoverability: ['/commands', '/help'],
      truthClass: 'live_proven',
      summary: 'Show smart thinking mode and deep/quick controls.',
      menuDescription: 'Thinking mode and controls',
    },
    {
      id: 'telegram_council',
      preferredAlias: '/council',
      acceptedAliases: ['/council'],
      audience: 'user',
      surfaceKind: 'slash',
      channelScope: ['telegram'],
      discoverability: ['/commands', '/help'],
      truthClass: 'live_proven',
      summary:
        'Show council quality, calibration, provider reliability, and next proof action.',
      menuDescription: 'Council quality status',
    },
    {
      id: 'telegram_cognition',
      preferredAlias: '/cognition',
      acceptedAliases: ['/cognition'],
      audience: 'user',
      surfaceKind: 'slash',
      channelScope: ['telegram'],
      discoverability: ['/commands', '/help'],
      truthClass: 'live_proven',
      summary:
        'Show cognitive task engine, Cognitive Workspace packet, Agent OS episode status, Runtime Spine checkpoints, Supervisor Core, Session Graph continuity, Logic Kernel beliefs, Truth Engine support, World Model proof debt, evidence gaps, approval blockers, and next repair action.',
      menuDescription: 'Cognition and continuity status',
    },
    {
      id: 'telegram_memory',
      preferredAlias: '/memory',
      ...
      discoverability: ['/commands', '/help'],
      truthClass: 'live_proven',
      summary: 'Show memory behavior and natural memory controls.',
      menuDescription: 'Memory behavior and controls',
    },
    {
      id: 'telegram_learning',
      preferredAlias: '/learning',
      acceptedAliases: ['/learning'],
      audience: 'user',
      surfaceKind: 'slash',
      channelScope: ['telegram'],
      discoverability: ['/commands', '/help'],
      truthClass: 'live_proven',
      summary: 'Show durable learning policy and safety rails.',
      menuDescription: 'Learning policy',
    },
    {
      id: 'telegram_forget',
      preferredAlias: '/forget',
      acceptedAliases: ['/forget'],
      audience: 'user',
      surfaceKind: 'slash',
      channelScope: ['telegram'],
      discoverability: ['/commands', '/help'],
      truthClass: 'live_proven',
      summary: 'Show how to disable a remembered detail.',
      menuDescription: 'Forget a learned detail',
    },
    {
...
export const OPERATOR_SLASH_COMMAND_SURFACES: readonly CommandSurfaceEntry[] = [
  ...
  family(
    ...
    '/openclaw',
    OPENCLAW_AGENT_COMMANDS,
    'Delegate an explicit operator prompt to the local OpenClaw gateway.',
    'operator',
    'operator_only',
  ),
  family(
    ...
    '/integrations',
    INTEGRATION_RECOVERY_COMMANDS,
    'Diagnose and safely guide recovery for blocked integrations.',
    'operator',
    'operator_only',
  ),
  family(
...
export const NATURAL_LANGUAGE_DISCOVERY_SURFACES: readonly CommandSurfaceEntry[] =
  [
    ...
    },
    {
      ...
      description:
        'The configured owner self-thread can support bounded summaries and separately approved send decisions when the Apple bridge is healthy. Ordinary contact and group threads are data-only, while Telegram remains the richer control surface.',
      statusAuthority:
...
export const OPERATOR_SCRIPT_SURFACES: readonly CommandSurfaceEntry[] = [
  ...
  {
    id: 'debug_council',
    preferredAlias: 'npm run debug:council',
    acceptedAliases: [
    ...
    discoverability: ['operator_docs'],
    truthClass: 'operator_only',
    summary: 'Redacted council quality, metric, evidence, and repair report.',
  },
  {
    id: 'debug_cognition',
    preferredAlias: 'npm run debug:cognition',
    acceptedAliases: [
      'npm run debug:cognition',
    ...
    truthClass: 'operator_only',
    summary:
      'Redacted cognitive kernel status, governed workbench, executor loop, checkpoints, trace replay, trajectory scoring, resume plan, and benchmark ladder.',
  },
  {
    id: 'debug_executive',
    preferredAlias: 'npm run debug:executive',
    acceptedAliases: [
      'npm run debug:executive',
      'npm run debug:executive -- --json',
      'npm run debug:executive -- --refresh --json',
    ],
    audience: 'operator',
    surfaceKind: 'script',
    channelScope: ['operator'],
  ...
  },
  {
    ...
    acceptedAliases: [
      ...
      'npm run debug:repair -- --json',
      'npm run debug:repair -- --id bluebubbles --dry-run --json',
    ...
    truthClass: 'operator_only',
    summary:
      'Redacted bounded repair playbook status, attempts, validation, cooldowns, and next action.',
  },
  {
    id: 'debug_agentic',
    preferredAlias: 'npm run debug:agentic',
    acceptedAliases: [
      'npm run debug:agentic',
      'npm run debug:agentic -- --json',
    ...
    truthClass: 'operator_only',
    summary:
      'Deterministic agentic evals for route selection, tool selection, repair behavior, safety, and reflection.',
  },
  {
    id: 'debug_agent_os',
    preferredAlias: 'npm run debug:agent-os',
    acceptedAliases: [
      'npm run debug:agent-os',
      ...
      'npm run debug:agent-os -- --plan-only <goal> --json',
    ...
    truthClass: 'operator_only',
    summary:
      'Redacted Agent OS episode, saved DAG plan, replay, interrupt, resume-token, tool-card, handoff, trajectory, and skill-proposal report.',
  },
  {
    id: 'debug_logic',
    preferredAlias: 'npm run debug:logic',
    acceptedAliases: [
      'npm run debug:logic',
    ...
    truthClass: 'operator_only',
    summary:
      'Redacted Logic Kernel belief, claim, reconciliation, contradiction, missing-premise, usefulness-score, and decision report.',
  },
  {
    id: 'debug_truth',
    preferredAlias: 'npm run debug:truth',
    acceptedAliases: [
      'npm run debug:truth',
      'npm run debug:truth -- --json',
      'npm run debug:truth -- --subject <query> --json',
      'npm run debug:truth -- --answer <answer> --json',
    ],
    audience: 'operator',
    surfaceKind: 'script',
    channelScope: ['operator'],
    ...
    truthClass: 'operator_only',
    summary:
      'Redacted Truth Engine answer audit with claim support, source coverage, calibration, and rewrite directives.',
  },
  {
    id: 'debug_world',
    preferredAlias: 'npm run debug:world',
    acceptedAliases: [
      'npm run debug:world',
    ...
    truthClass: 'operator_only',
    summary:
      'Redacted World Model snapshot, proof debt, stale evidence, safe verification, skill trust, and next useful action report.',
  },
  {
    id: 'debug_runtime_spine',
    preferredAlias: 'npm run debug:runtime-spine',
    acceptedAliases: [
      'npm run debug:runtime-spine',
      'npm run debug:runtime-spine -- --json',
      'npm run debug:runtime-spine -- --run <id> --json',
      'npm run debug:runtime-spine -- --events <id>',
    ],
    audience: 'operator',
    surfaceKind: 'script',
    channelScope: ['operator'],
    ...
    truthClass: 'operator_only',
    summary:
      'Redacted v17 runtime spine linking World Model, Agent OS, checkpoints, guardrails, Truth, Logic, approval staging, and replayable events.',
  },
  {
    id: 'debug_supervisor',
    preferredAlias: 'npm run debug:supervisor',
    acceptedAliases: [
      'npm run debug:supervisor',
      'npm run debug:supervisor -- --json',
      'npm run debug:supervisor -- --run <id> --json',
      'npm run debug:supervisor -- --runtime <id> --json',
      'npm run debug:supervisor -- --blackboard <id> --json',
    ],
    audience: 'operator',
    surfaceKind: 'script',
    channelScope: ['operator'],
    ...
    truthClass: 'operator_only',
    summary:
      'Redacted v18 Supervisor Core report with active participant, shared blackboard, handoff queue, termination reason, budget, and next safe action.',
  },
  {
    id: 'debug_session_graph',
    preferredAlias: 'npm run debug:session-graph',
    acceptedAliases: [
      'npm run debug:session-graph',
      'npm run debug:session-graph -- --json',
      'npm run debug:session-graph -- --cockpit',
      'npm run debug:session-graph -- --cockpit --json',
      'npm run debug:session-graph -- --cluster <id> --json',
    ...
    truthClass: 'operator_only',
    summary:
      'Redacted v19/v20 Session Graph continuity report linking channel turns, sessions, runtime, supervisor, cognition, proof debt, approvals, and a ranked continuity cockpit.',
  },
  {
    id: 'debug_agency_loop',
    preferredAlias: 'npm run debug:agency-loop',
    acceptedAliases: [
      'npm run debug:agency-loop',
      ...
      'npm run debug:agency-loop -- --run <id> --json',
    ],
    audience: 'operator',
    surfaceKind: 'script',
    channelScope: ['operator'],
    ...
    truthClass: 'operator_only',
    summary:
      'Redacted v21 agency convergence loop report connecting Session Graph action queue, Runtime Spine, Supervisor, Logic, Truth, provider participation, and refreshed next action.',
  },
  {
    id: 'debug_cognitive_workspace',
    preferredAlias: 'npm run debug:cognitive-workspace',
    acceptedAliases: [
      'npm run debug:cognitive-workspace',
      'npm run debug:cognitive-workspace -- --json',
      'npm run debug:cognitive-workspace -- --packet <id> --json',
      'npm run debug:cognitive-workspace -- --optimize --json',
      'npm run debug:cognitive-workspace -- --execute --json',
    ],
    audience: 'operator',
    surfaceKind: 'script',
    channelScope: ['operator'],
    ...
    truthClass: 'operator_only',
    summary:
      'Redacted v22 Cognitive Workspace report linking Session Graph, World, Runtime Spine, Supervisor, Agent OS, Logic, Truth, provider plan, programs, and candidate-only improvement proposals.',
  },
  {
    id: 'debug_harness',
    preferredAlias: 'npm run debug:harness',
    acceptedAliases: [
      'npm run debug:harness',
      'npm run debug:harness -- --json',
      'npm run debug:harness -- --rho --json',
      'npm run debug:harness -- --stored --json',
    ],
    audience: 'operator',
    surfaceKind: 'script',
    channelScope: ['operator'],
    ...
    truthClass: 'operator_only',
    summary:
      'Redacted v14 local harness lab with offline task trajectories, scorecards, and candidate-only improvement proposals.',
  },
  {
    id: 'test_cognition_benchmarks',
    preferredAlias: 'npm run test:cognition:benchmarks',
    acceptedAliases: [
    ...
    truthClass: 'operator_only',
    summary:
      'Deterministic cognition benchmark, trace replay, cooldown, executor loop, adapter, trajectory, governance, memory-block, workbench, Agent OS DAG planner, runtime spine checkpoint/guardrail proof, supervisor loop, Session Graph continuity, agency convergence, logic reconciliation, truth calibration, World Model proof debt, harness-lab, and meta-learning proof.',
  },
];
...
export function buildTelegramCommandLines(): string[] {
  ...
  return [
    ...
    render('telegram_bluebubbles'),
    render('telegram_cursor_status'),
    '',
    '*Thinking and Memory*',
    render('telegram_thinking'),
    render('telegram_council'),
    render('telegram_cognition'),
    render('telegram_memory'),
    render('telegram_learning'),
    render('telegram_forget'),
    '',
    '*In Groups*',
