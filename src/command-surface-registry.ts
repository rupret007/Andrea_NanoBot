...
export const PUBLIC_TELEGRAM_COMMAND_SURFACES: readonly CommandSurfaceEntry[] =
  [
    ...
    },
    {
      ...
      truthClass: 'live_proven',
      summary:
        'Show cognitive task engine status, active skill, evidence gaps, approval blockers, and next repair action.',
      menuDescription: 'Cognitive task engine status',
    },
    {
      id: 'telegram_memory',
...
export const OPERATOR_SCRIPT_SURFACES: readonly CommandSurfaceEntry[] = [
  ...
  },
  {
    ...
    truthClass: 'operator_only',
    summary:
      'Redacted cognitive kernel status, executor loop, checkpoints, trace replay, trajectory scoring, resume plan, and benchmark ladder.',
  },
  {
    ...
    truthClass: 'operator_only',
    summary:
      'Deterministic cognition benchmark, trace replay, cooldown, executor loop, adapter, trajectory, and meta-learning proof.',
  },
];
