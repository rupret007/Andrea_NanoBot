...
describe('bounded named reply delay grammar', () => {
  it.each([
    ...
    ['remind me in an hour', 60],
    ['remind me to reply in a minute', 1],
    ['remind me about that in half an hour', 30],
    ['remind me in half hour', 30],
    ['remind me in half a hour', 30],
    ['remind me to reply in half hour', 30],
    ['remind me in 45 mins', 45],
    ['remind me to reply in 2 hrs', 120],
    ['remind me in 90 min', 90],
  ...
  it.each([
    ...
    'remind me in half a minute',
    'remind me in half minute',
    'remind me in half an hour and a half',
    'remind me in half hour and a half',
