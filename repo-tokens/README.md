...
Composite GitHub Action. It installs tiktoken and runs the checked-in
`count_tokens.py` helper so workflow scanners can inspect the implementation as
normal source. It usually takes about 10 seconds.
