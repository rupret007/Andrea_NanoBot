...
> Legacy reference only. This document preserves earlier NanoClaw extension strategy and is not the source of truth for Andrea_OpenAI_Bot. See [Docs Index](README.md) and [Legacy Reference](LEGACY_REFERENCE.md).
