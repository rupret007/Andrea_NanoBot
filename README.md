...
- after a named owed reply, `remind me to reply tomorrow at 9am` or `remind me at 9:30pm today` sets an exact reminder to the owner control chat. The confirmation shows its date and configured timezone; invalid, past or ambiguous daylight-saving times ask for another time without creating a task. This keeps the reply unsent. See [reply reminder timing](docs/COMMUNICATION_COMPANION.md#exact-reply-reminder-times).
