...
- after a named owed reply, `remind me in 30 minutes` or `remind me to reply in 2 hours` creates a local owner-chat reminder with a date/time/timezone confirmation. Whole-number delays support 1–1,440 minutes or 1–24 hours, anchored to the original live arrival receipt so retries cannot slide the due time. Missing or expired timing evidence asks for a fresh choice; history-only messages cannot create this reminder. See [short reply delays](docs/COMMUNICATION_COMPANION.md#short-reply-delays).
