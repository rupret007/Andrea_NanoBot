/**
 * Stdio MCP server for the Andrea runtime.
 * Keeps the legacy "nanoclaw" MCP server name for compatibility with imported
 * runtime state and existing tool wiring.
 */
