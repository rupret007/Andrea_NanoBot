...
| Surface                          | What it does                                                                                                                             | Notes                                                                                                                                                                                           |
| -------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Alexa Companion Mode             | Routes approved Alexa voice requests into Andrea with daily guidance, short conversational continuity, and consent-based personalization | Optional operator-enabled ingress; requires supported Node `22.x` (`>=22 <23`), HTTPS, account linking, trust verification, and one real signed utterance for full live acceptance; CI, Windows, and the container use the exact `22.22.2` pin; status check is `/alexa-status` |
