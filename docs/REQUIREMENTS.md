...
> **Historical note:** Telegram, Slack, Discord, and Gmail skill work exists.
> Andrea's old Apple Container migration skill is retired; current agent
> execution fails closed on Apple Container pending equivalent nested read-only
> mount proof.
