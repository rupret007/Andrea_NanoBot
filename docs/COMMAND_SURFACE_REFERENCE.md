...
| `/thinking`      | User     | `live_proven` | Show smart thinking mode plus deep/quick controls              |
| `/council`       | User     | `live_proven` | Show council quality, calibration, provider reliability, and next proof action |
| `/cognition`     | User     | `live_proven` | Show cognitive task engine status, active skill, evidence gaps, approval blockers, and next repair action |
